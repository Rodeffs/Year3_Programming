...
def parse():
    ...
    parser.add_argument("-e", type=float, help="the end of the clip, will default to input duration if bigger than it")
...
def main():
    ...
    begin = args.b if args.b < video.duration else 0
    end = args.e if args.e < video.duration else video.duration
